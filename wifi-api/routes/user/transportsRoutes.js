...
const controller = require('../../controllers/user/transportsController');
...
router.post('/',       passport.authenticate('jwt', {session:false}), controller.createPlease);  //доступ со (status:2), создание Transport c полем (companyId) jwt токена
